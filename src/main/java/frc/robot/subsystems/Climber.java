...
public class Climber extends Subsystem {
    ...
    public Climber() {
        super("Climber");
        this.frontClimb = new DoubleSolenoid(1, RobotMap.frontClimberExtend, RobotMap.frontClimberRetract);
        this.backClimb = new DoubleSolenoid(1, RobotMap.backClimberExtend, RobotMap.backClimberRetract);
