 ...
 */
public class DifferentialDriveCorrection extends RobotDriveBase {
   ...
   */
  public DifferentialDriveCorrection(SpeedController leftMotor, SpeedController rightMotor) {
    ...
    instances++;
    setName("DifferentialDriveCorrection", instances);
  }
